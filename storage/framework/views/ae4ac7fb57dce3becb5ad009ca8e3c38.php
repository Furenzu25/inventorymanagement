...
$__html = app('livewire')->mount($__name, $__params, 'lw-327278053-2', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <div @click="open = !open">
                            <?php if(auth()->user()->customer?->profile_image): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-327278053-3', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH C:\laragon\www\inventorymanagement\resources\views\livewire\ecommerce\components\nav-bar.blade.php ENDPATH**/ ?>