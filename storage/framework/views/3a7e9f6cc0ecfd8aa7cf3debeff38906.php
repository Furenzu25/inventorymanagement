                    ...
                    <tbody>
                        <?php $__currentLoopData = $accountReceivables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-[#D2DCE6] hover:bg-[#F2F2EB] transition-colors duration-200">
                                ...
                                <td class="px-4 py-3">
                                    <?php $__currentLoopData = $ar->preorder->preorderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td class="px-4 py-2 text-[#401B1B]">₱<?php echo e(number_format($ar->total_paid > 0 ? $ar->total_paid : 0, 2)); ?></td>
                                <td class="px-4 py-2 text-[#401B1B]">₱<?php echo e(number_format($ar->getTotalAmountWithInterest() - $ar->total_paid, 2)); ?></td>
                                <td class="px-4 py-2">
                                    <?php if($ar->loan_start_date && $ar->loan_end_date): ?>
