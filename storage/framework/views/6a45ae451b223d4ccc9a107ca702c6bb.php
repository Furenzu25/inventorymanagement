                        ...
                        <tr class="hover:bg-[#F2F2EB]/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-[#401B1B]">
                                    <?php if($sale->accountReceivable && $sale->accountReceivable->preorder): ?>
                                        <?php $__currentLoopData = $sale->accountReceivable->preorder->preorderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
