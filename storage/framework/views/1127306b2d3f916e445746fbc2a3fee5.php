<div>
                    ...
                    <?php if($product): ?>
                        <div class="space-y-6">
                            ...
                            <div class="bg-white/50 p-4 rounded-lg shadow-inner">
                                ...
                                <div class="text-[#72383D]"><?php echo e($product->product_name); ?></div>
                            </div>

                            <!-- Price -->
                            <div class="bg-white/50 p-4 rounded-lg shadow-inner">
                                <label class="block text-sm font-semibold text-[#401B1B] mb-2">Price</label>
                                <div class="text-[#72383D] font-medium">₱<?php echo e(number_format($product->price, 2)); ?></div>
                            </div>
                            ...
                            <div class="bg-white/50 p-4 rounded-lg shadow-inner">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <span class="text-[#72383D] font-medium text-lg"><?php echo e($quantity); ?></span>
                                    <button 
                            ...
                            <div class="bg-white/50 p-4 rounded-lg shadow-inner">
                                ...
                                <div class="text-[#72383D] font-bold text-lg">
                                    ₱<?php echo e(number_format($product->price * $quantity, 2)); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\inventorymanagement\resources\views\livewire\ecommerce\add-to-cart-modal.blade.php ENDPATH**/ ?>