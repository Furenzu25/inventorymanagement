...
<?php $component = Mary\View\Components\Button::resolve(['icon' => 'o-power','tooltipLeft' => 'logoff','noWireNavigate' => true,'link' => '/logout'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\MenuItem::resolve(['title' => 'Dashboard','icon' => 'bi-file-earmark-person-fill','link' => '/'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\inventorymanagement\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>