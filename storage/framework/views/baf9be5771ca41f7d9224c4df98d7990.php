...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white/80 rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $paymentSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-[#72383D]/10">
                ...
                <tbody class="divide-y divide-[#72383D]/10">
                    <?php $__empty_1 = true; $__currentLoopData = $this->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php if($selectedCustomer): ?>
                        ...
                        <div class="mb-6">
                            ...
                            <select wire:model="selectedAR" wire:change="selectAR($event.target.value)" 
                                ...
                                <?php $__currentLoopData = $selectedCustomer->accountReceivables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($selectedAR && $selectedCustomerPayments->isNotEmpty()): ?>
                            <div class="overflow-x-auto rounded-lg border border-[#72383D]/10 shadow-lg mt-6">
                                <table class="min-w-full divide-y divide-[#72383D]/10">
                                    ...
                                    <tbody class="bg-white/50 divide-y divide-[#72383D]/10">
                                        <?php $__currentLoopData = $selectedCustomerPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
