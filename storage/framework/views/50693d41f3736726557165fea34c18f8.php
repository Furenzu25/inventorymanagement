         ...
         <?php $__env->slot('actions', null, []); ?> 
            <div class="flex items-center space-x-6">
                <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                    <!-- Home Icon -->
                    <a href="<?php echo e(route('home')); ?>" class="text-[#F2F2EB] hover:text-[#AB644B] transition-all duration-300">
                        <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
[$__name, $__params] = $__split('ecommerce.customer-notifications');

$__html = app('livewire')->mount($__name, $__params, 'lw-1714517064-0', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('cart')); ?>" class="text-[#F2F2EB] hover:text-[#AB644B] transition-all duration-300 relative">
                        <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <div @click="open = !open">
                            <!--[if BLOCK]><![endif]--><?php if(auth()->user()->customer?->profile_image): ?>
                                <img src="<?php echo e(Storage::url(auth()->user()->customer->profile_image)); ?>" 
                                     alt="Profile" 
...
<?php $component = Mary\View\Components\Button::resolve(['icon' => 'o-user-circle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-ghost text-[#F2F2EB] hover:text-[#AB644B] w-12 h-12']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <div x-show="open" 
                            ...
                            <a href="<?php echo e(route('profile')); ?>" class="flex items-center px-4 py-2 text-gray-800 hover:bg-[#AB644B]/10">
                                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('customer.orders')); ?>" class="flex items-center px-4 py-2 text-gray-800 hover:bg-[#AB644B]/10">
                                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('customer.payments')); ?>" class="flex items-center px-4 py-2 text-gray-800 hover:bg-[#AB644B]/10">
                                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-[#72383D]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce0070e6ae017cca68172d0230e44821)): ?>
<?php $attributes = $__attributesOriginalce0070e6ae017cca68172d0230e44821; ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1714517064-1', $__slots ?? [], get_defined_vars());
...
if (isset($__slots)) unset($__slots);
?>
</div><?php /**PATH C:\laragon\www\inventorymanagement\resources\views/livewire/ecommerce/components/nav-bar.blade.php ENDPATH**/ ?>