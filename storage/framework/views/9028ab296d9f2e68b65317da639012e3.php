                            ...
                            <div class="mt-8 space-y-4">
                                <div>
                                    ...
                                    <select wire:model="loanDuration" id="loanDuration" 
                                        ...
                                        <?php $__currentLoopData = $loanDurationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $months => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($months); ?>"><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php $__errorArgs = ['loanDuration'];
...
<?php endif; ?><?php /**PATH C:\laragon\www\inventorymanagement\resources\views\livewire\ecommerce\cart.blade.php ENDPATH**/ ?>