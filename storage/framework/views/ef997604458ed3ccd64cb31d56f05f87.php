...
<?php endif; ?>
                                    ...
                                    <?php if(session()->has('profile_message')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1044961591-1', $__slots ?? [], get_defined_vars());
