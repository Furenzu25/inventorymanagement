        ...
        <div class="bg-white shadow-2xl rounded-lg overflow-hidden">
            <div class="p-4 sm:p-6 md:p-8">
                <div class="mb-6 text-center">
                    ...
                    <h2 class="text-3xl font-bold" style="background: linear-gradient(45deg, #3498db, #2ecc71); -webkit-background-clip: text; background-clip: text; color: transparent;">Forgot Password</h2>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="font-medium text-[#3498db] hover:text-[#2980b9]">Back to Login</a>
                </p>
            </div>
        </div>
    </div>
