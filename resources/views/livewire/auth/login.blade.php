        ...
        <div class="bg-white shadow-2xl rounded-lg overflow-hidden">
            <div class="p-4 sm:p-6 md:p-8">
                <div class="mb-6 text-center">
                    ...
                    <h2 class="text-3xl font-bold text-gray-800">Welcome to Rosels Trading</h2>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-blue-600 hover:text-blue-500">Create an account</a>
                </p>
            </div>
            <div class="mt-4 text-center pb-6">
                <span class="mx-2">|</span>
                <a href="{{ route('password.request') }}" class="text-blue-500 hover:text-blue-400">Forgot your password?</a>
            </div>
        </div>
    </div>
</div>
