    ...
    <main class="p-4 sm:p-6 md:p-8">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-black/30 backdrop-blur-md overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 sm:px-20 border-b border-red-500/30">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            @foreach($products as $product)
                                <div class="border border-red-500/30 p-4 rounded-lg flex flex-col">
                                    ...
                                    <div class="mt-4 flex justify-between items-center">
                                        <x-button wire:click="addToCart({{ $product->id }})" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded transition duration-300">
                                            Add to Cart
                                        </x-button>
                                        <a href="#" class="text-red-500 hover:text-red-400 transition duration-300" onclick="showProductDetails({{ $product->id }})">View Details</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
